...
##############################################################################
"""
Air separation phase equilibrium package using van der Waals EoS.
...
phase equilibrium in the generic framework using van der Waals equation
...
configuration = {
    ...
    "parameter_data": {"VDW_kappa": {("nitrogen", "nitrogen"): 0.000,
